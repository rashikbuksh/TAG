...
CREATE TABLE `category` (
    `id` int(11) NOT NULL, `name` varchar(255) NOT NULL, `url` varchar(255) DEFAULT NULL
...
CREATE TABLE `customer_profile` (
    `id` int(11) NOT NULL, `name` varchar(100) DEFAULT NULL, `image` varchar(255) DEFAULT NULL, `point` varchar(255) DEFAULT NULL, `level` varchar(255) DEFAULT NULL, `user_name` varchar(100) DEFAULT NULL, `password` varchar(255) DEFAULT NULL, `phone` varchar(11) DEFAULT NULL, `email` varchar(255) DEFAULT NULL, `shipping_address` varchar(255) DEFAULT NULL, `total_order` int(11) DEFAULT NULL, `address` text DEFAULT NULL, `review_count` int(11) DEFAULT NULL, `offer` varchar(255) DEFAULT NULL, `access` varchar(255) NOT NULL, `active_status` tinyint(1) DEFAULT NULL, `refer_code` varchar(255) NOT NULL, `refer_status` varchar(255) DEFAULT NULL, `profile_picture` varchar(255) DEFAULT NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
INSERT INTO
    `customer_profile` (
        `id`, `name`, `image`, `point`, `level`, `user_name`, `password`, `phone`, `email`, `shipping_address`, `total_order`, `address`, `review_count`, `offer`, `access`, `active_status`, `refer_code`, `refer_status`, `profile_picture`
    )
VALUES (
...
CREATE TABLE `hero_slider` (
    `id` int(11) NOT NULL, `title` varchar(255) DEFAULT NULL, `subtitle` varchar(255) DEFAULT NULL, `image` varchar(255) DEFAULT NULL, `slider_position` varchar(50) DEFAULT NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
INSERT INTO
    `hero_slider` (
        `id`, `title`, `subtitle`, `image`, `slider_position`
    )
VALUES (
...
CREATE TABLE `news` (
    `id` int(11) NOT NULL, `shopper_product_id` int(11) DEFAULT NULL, `shop_id` int(11) NOT NULL, `date` varchar(255) NOT NULL, `discount` varchar(255) DEFAULT NULL, `duration` varchar(255) DEFAULT NULL, `location` varchar(255) DEFAULT NULL, `like_count` int(11) DEFAULT 0, `comment_count` int(11) DEFAULT 0, `share_count` int(11) DEFAULT 0, `rating` double DEFAULT 0, `category` varchar(255) DEFAULT NULL, `post_content` varchar(255) NOT NULL, `post_img` varchar(255) NOT NULL
...
INSERT INTO
    `news` (
        `id`, `shopper_product_id`, `shop_id`, `date`, `discount`, `duration`, `location`, `like_count`, `comment_count`, `share_count`, `rating`, `category`, `post_content`, `post_img`
    )
VALUES (
    ...
    (
        54, 78, 17, '2024-01-07 22:00:38', '16', '', '', 0, 0, 0, 0, 'regular', 'Alo Potato TK 58.80', '1689276807795__Welcome Scan.jpg'
    ),
    (
        55, 79, 17, '2024-01-07 22:00:39', '16', '', '', 0, 0, 0, 0, 'regular', 'Hand bag In Town TK 168.00', '1696949606356__bag.png'
    );
...
CREATE TABLE `news_comment` (
    `id` int(11) NOT NULL, `news_id` int(11) NOT NULL, `commented_by` int(11) NOT NULL, `comment` varchar(255) NOT NULL, `news_time` varchar(255) NOT NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
INSERT INTO
    `news_comment` (
        `id`, `news_id`, `commented_by`, `comment`, `news_time`
    )
VALUES (
...
CREATE TABLE `news_like` (
    `id` int(11) NOT NULL, `news_id` int(11) NOT NULL, `liked_by` int(11) NOT NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
CREATE TABLE `notification` (
    `id` int(11) NOT NULL, `notification_content` varchar(255) DEFAULT NULL, `notification_time` varchar(255) DEFAULT NULL, `not_from` int(11) NOT NULL, `not_to` int(11) NOT NULL, `status` int(11) DEFAULT 0
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
INSERT INTO
    `notification` (
        `id`, `notification_content`, `notification_time`, `not_from`, `not_to`, `status`
    )
VALUES (
    ...
    (
        58, 'You have a new order. Order Number is #93.', '2024-01-07 21:07:44', 17, 16, 1
    ),
    (
...
CREATE TABLE `ordered_product` (
    `id` int(11) NOT NULL, `order_id` int(11) NOT NULL, `product_id` int(11) NOT NULL, `discount` decimal(20, 3) NOT NULL, `quantity` decimal(20, 3) NOT NULL, `price` decimal(20, 3) NOT NULL, `weight` decimal(20, 3) NOT NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
INSERT INTO
    `ordered_product` (
        `id`, `order_id`, `product_id`, `discount`, `quantity`, `price`, `weight`
    )
VALUES (
        5, 93, 41, 4.000, 2.000, 434.000, 0.000
    ),
    (
        6, 93, 32, 10.000, 2.000, 201.000, 0.000
    ),
    (
        7, 94, 41, 4.000, 2.000, 434.000, 0.000
    ),
    (
        8, 94, 32, 10.000, 2.000, 201.000, 0.000
    );
...
CREATE TABLE `product` (
    `id` int(11) NOT NULL, `sku` varchar(255) DEFAULT NULL, `name` varchar(100) DEFAULT NULL, `image` varchar(255) DEFAULT NULL, `short_description` varchar(100) DEFAULT NULL, `full_description` varchar(255) DEFAULT NULL, `category_id` int(11) NOT NULL, `isVerified` varchar(15) DEFAULT NULL, `price` decimal(20, 3) DEFAULT NULL, `quantity` int(11) DEFAULT NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
INSERT INTO
    `product` (
        `id`, `sku`, `name`, `image`, `short_description`, `full_description`, `category_id`, `isVerified`, `price`, `quantity`
    )
VALUES (
...
CREATE TABLE `product_order` (
    `id` int(11) NOT NULL, `order_status` varchar(255) DEFAULT NULL, `customer_profile_id` int(11) NOT NULL, `shopper_id` int(11) NOT NULL, `price` decimal(20, 3) NOT NULL, `cancel_report` text DEFAULT NULL, `order_time` datetime NOT NULL, `shopper_order_accept_time` datetime DEFAULT NULL, `delivery_time` datetime DEFAULT NULL, `order_delay_report` varchar(25) DEFAULT NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
INSERT INTO
    `product_order` (
        `id`, `order_status`, `customer_profile_id`, `shopper_id`, `price`, `cancel_report`, `order_time`, `shopper_order_accept_time`, `delivery_time`, `order_delay_report`
    )
VALUES (
        93, 'pending', 16, 17, 1195.080, NULL, '2024-01-07 21:07:44', NULL, NULL, NULL
    ),
    (
        94, 'pending', 16, 17, 1195.080, '', '2024-01-07 21:08:42', '2024-01-19 23:59:59', NULL, NULL
    );
...
CREATE TABLE `refer` (
    `id` int(11) NOT NULL, `referred_by` int(11) NOT NULL, `referred_to` int(11) NOT NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
CREATE TABLE `shopper_product` (
    `id` int(11) NOT NULL, `name` varchar(255) NOT NULL, `price` decimal(20, 3) NOT NULL, `discount` decimal(20, 3) NOT NULL, `product_count` int(11) NOT NULL, `sale_count` int(11) DEFAULT 0, `wishlist_count` int(11) DEFAULT 0, `rating_count` int(11) DEFAULT 0, `product_id` int(11) NOT NULL, `shopper_id` int(11) NOT NULL, `view` int(11) NOT NULL DEFAULT 0
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
INSERT INTO
    `shopper_product` (
        `id`, `name`, `price`, `discount`, `product_count`, `sale_count`, `wishlist_count`, `rating_count`, `product_id`, `shopper_id`, `view`
    )
VALUES (
    ...
    (
        34, 'Potato Chips ', 10.000, 0.000, 100, 50, 0, 0, 17, 17, 2
    ),
    (
    ...
    (
        78, 'Alo Potato', 70.000, 16.000, 5, 0, 0, 0, 11, 17, 0
    ),
    (
        79, 'Hand bag In Town', 200.000, 16.000, 15, 0, 0, 0, 15, 17, 0
    );
...
CREATE TABLE `shopper_schedule` (
    `id` int(11) NOT NULL, `shopper_id` int(11) NOT NULL, `schedule_day` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`schedule_day`))
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
INSERT INTO
    `shopper_schedule` (
        `id`, `shopper_id`, `schedule_day`
    )
VALUES (
        5, 17, '[[\"Sunday\",\"1000\"],[\"Monday\",\"1000\"],[\"Tuesday\",\"1000\"],[\"Wednesday\",\"1000\"],[\"Thursday\",\"1000\"],[\"Friday\",\"10000\"],[\"Saturday\",\"1000\"]]'
    ),
    (
...
CREATE TABLE `util` (
    `id` int(11) NOT NULL, `label` varchar(255) NOT NULL, `value` varchar(255) NOT NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
--
ALTER TABLE `hero_slider` ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `refer` ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `util` ADD PRIMARY KEY (`id`);
