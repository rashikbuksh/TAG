                  ...
                  <div className="my-16">
					...
					<div>
                      {shopperInfo.map((shopper, key) => (
                        <div key={shopper.id} className="flex items-center justify-between">
                         <h4 className="text-lg font-semibold">  {shopper.name}</h4>
                        <FaX></FaX>
                        </div>
                      ))}
                    </div>
                        ...
                        <div className="flex gap-10  items-center">
                          ...
                          <div className="price">
                            {cartItem.discount && cartItem.discount > 0 ? (
                              <Fragment>
                                <span className="main-price me-1 text-[10px]">{`$${cartItem.price}`}</span>
            ...
            <div className="container">
              <div className="row">
                <div className="col-12">
                  ...
                  <Link to={import.meta.env.VITE_API_PUBLIC_URL + "/checkout"}>
                    Proceed to Checkout
                  </Link>
                </div>
              </div>
