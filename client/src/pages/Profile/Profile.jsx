...
const Profile = () => {
	...
	return (
		<div className="body-wrapper  space-pt--70 space-pb--120 ">
			...
			{/*--------------------------------------- New profile header------------------------- */}
			<div className="mx-2 my-8 flex items-center rounded-lg bg-white p-4 py-4">
				<img
			...
			{/*----------------------------------------New Profile body----------------------------  */}
			<div className="my-4 overflow-hidden rounded-lg  bg-white">
