  ...
  const postsData = [
    {
      ...
      shareCount: 5,
      rating: 4.5,
      productImage:"https://img.freepik.com/free-vector/realistic-chips-package_1284-34786.jpg?w=826&t=st=1691298851~exp=1691299451~hmac=f0f2f77684302248188778a32b0a8acd676af9a5e21ad7be5c15d05cbf5639c8",
    ...
    },
    {
      ...
      shareCount: 4,
      rating: 3.8,
      productImage:"https://img.freepik.com/free-vector/chips-color-pack-cheese-salmon-tastes-realistic_1284-7393.jpg?w=826&t=st=1691300602~exp=1691301202~hmac=7dde67557b384a40696f51e37475eca21054c10c68071105e8761fddb72f8ac4",
    ...
    },
    {
        ...
        shareCount: 5,
        rating: 4.5,
        PostContent:"বাবার চেয়ে দায়িত্বশীল কোনো পুরুষ হয় না, আর মায়ের চেয়ে বেশি যত্নবান কোনো নারী হয় না।",
        postimg:
          "",
    },
    {
    ...
    },
    {
      ...
      shareCount: 6,
      rating: 4.3,
      productImage:"https://img.freepik.com/free-vector/realistic-soda-with-ice-advertisement_52683-8078.jpg?w=826&t=st=1691300696~exp=1691301296~hmac=1e88243826a65eb4c821c84bc83da8138e98decc93bfad1678c2b8497804c30b",
      ...
      <div className="w-[90%] mx-auto">
        ...
        <div className="lg:grid lg:grid-cols-12 ">
          ...
          <div className="lg:col-span-6">
            ...
            <div>
              {postsData.map((postData, index) =>   postData.category === "post" ? (
