        ...
        <Header/>
			<div className="p-6 mt-14">
				...
				<ul>
					...
					<li>
						<p>
							<strong>Application</strong> refers to TAG Think And
							Get, the software program provided by the Company.
						</p>
					</li>
					<li>
						<p>
							...
							refers to TAG Think And Get, port Saleh Juhur,
							Chattogram 4100.
						</p>
					</li>
					<li>
					...
					<li>
						<p>
							<strong>Website</strong> refers to TAG Think And
							Get, accessible from{" "}
							<a
								href="https://www.tagthinkandget.com"
								rel="external nofollow noopener"
								target="_blank"
							>
								https://www.tagthinkandget.com
							</a>
						</p>
					</li>
					<li>
				...
				<ul>
					<li>
						<p>By email: tag@thinkandget.com</p>
					</li>
					<li>
						<p>
							...
							<a
								...
								target="blank"
							>
								https://www.facebook.com/thinkandget10
							</a>
						</p>
					</li>
					<li>
						<p>By phone number: 01533161339</p>
					</li>
				</ul>
			</div>
		</>
