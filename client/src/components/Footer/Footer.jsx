	...
	return (
		<footer>
			<div className="footer-nav-wrapper">
				...
				{user.access === "shopper" ? (
					<Link
						to={import.meta.env.VITE_API_PUBLIC_URL + "/shopkeeperDashboard"}
						className="footer-nav-single"
					>
						<div className="menu-wrapper">
      ...
      <g clipPath="url(#clip0_113_1473)">
        <path d="M12.5 2.75V4.75" stroke="#121331" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M17.96 13.67L19.75 17.25H5.25L7.04 13.67C7.18 13.39 7.25 13.09 7.25 12.78V10C7.25 7.1 9.6 4.75 12.5 4.75C15.4 4.75 17.75 7.1 17.75 10V12.78C17.75 13.09 17.82 13.4 17.96 13.67Z" stroke="#121331" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M14.75 17.25V19C14.75 20.24 13.74 21.25 12.5 21.25C11.26 21.25 10.25 20.24 10.25 19V17.25" stroke="#121331" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      </g>
      <defs>
      ...
      <g clipPath="url(#clip0_113_1397)">
        <path d="M12.5 21.25C17.6086 21.25 21.75 17.1086 21.75 12C21.75 6.89137 17.6086 2.75 12.5 2.75C7.39137 2.75 3.25 6.89137 3.25 12C3.25 17.1086 7.39137 21.25 12.5 21.25Z" stroke="#121331" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path fillRule="evenodd" clipRule="evenodd" d="M6.44467 18.9926L6.61151 18.7616C7.41053 17.6553 8.69218 17 10.0568 17H14.9437C16.3085 17 17.5902 17.6554 18.3892 18.7618L18.5558 18.9925C18.9397 18.6597 19.2959 18.2959 19.6206 17.9048L19.6052 17.8836C18.5242 16.3867 16.7901 15.5 14.9437 15.5H10.0568C8.21054 15.5 6.47654 16.3866 5.39552 17.8833L5.37988 17.9049C5.70452 18.296 6.06075 18.6598 6.44467 18.9926Z" fill="#121331"/>
        <path d="M9.75 9C9.75 7.48122 10.9812 6.25 12.5 6.25V6.25C14.0188 6.25 15.25 7.48122 15.25 9V10.5C15.25 12.0188 14.0188 13.25 12.5 13.25V13.25C10.9812 13.25 9.75 12.0188 9.75 10.5V9Z" stroke="#121331" strokeWidth="1.5" strokeLinejoin="round"/>
      </g>
      <defs>
