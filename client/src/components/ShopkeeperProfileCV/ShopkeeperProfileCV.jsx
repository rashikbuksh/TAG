...
import { FaRegMessage, FaCartShopping, FaLocationDot } from "react-icons/fa6";
  ...
  const products = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1624821622383-f213ad4c0403?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80",
    },
    {
      id: 2,
      name: "Product 2",
      ...
      image:
        "https://plus.unsplash.com/premium_photo-1684923611409-dc83b23b73e9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80",
    },
    {
      id: 3,
      name: "Product 3",
      ...
      image:
        "https://plus.unsplash.com/premium_photo-1674406481284-43eba097a291?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80",
    },
    {
      id: 4,
      name: "Product 4",
      ...
      <div className="w-[70%] mx-auto">
        <div className="w-[100%] mx-auto my-3  border border-gray-50 ">
          <div className="flex justify-between items-center p-4 ">
            <h1 title="shop id" className="text-base font-semibold">
              {storeid}
            </h1>
            <h1 title="shop Name" className="text-2xl font-bold">
              {shopname}
            </h1>
            <div>
              <Rating
