...
//   const productName = "Bombay Sweets Ring Chips";
  ...
  return (
    <div className=" w-[500px] border border-gray-100 mx-auto rounded-md">
      <div className="p-1">
      ...
      <MainProduct productImage={productImage} productName={productName}></MainProduct>
    </div>
  );
};
