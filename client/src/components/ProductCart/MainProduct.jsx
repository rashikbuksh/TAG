...
import { FaCross, FaMapMarkerAlt, FaMinus, FaPlus, FaWindowClose } from "react-icons/fa";
  ...
  return (
    <div>
      ...
      <div className="border-y-2 py-2 text-center border-gray-100">
        <Link to={import.meta.env.VITE_API_PUBLIC_URL + `/product/${id}`}>
      ...
      >
        <img
          className={`object-contain h-52 w-96 my-3 rounded ${
            quantity > 0 ? "hover:scale-90 transition-transform" : ""
          }`}
