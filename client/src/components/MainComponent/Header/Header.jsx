              ...
              <div className="">
                <div className="header-search">
                  <form onSubmit={onSubmit}>
                    ...
                    />
                    <Link to={import.meta.env.VITE_API_PUBLIC_URL + "/search/" + search}>
                      <ReactSVG
                        src={import.meta.env.VITE_API_PUBLIC_URL + "/assets/img/icons/search.svg"}
                      />
                    </Link>
                  </form>
                </div>
                                ...
                                <div className="h-8 w-8 rounded-full ring ring-[#2F5BA9] ">
                                  {user.profile_picture !== null ? (
                                    <img
                                      ...
                                      src={`${import.meta.env.VITE_APP_IMG_URL}/usersProfilePic/${user.profile_picture}`}
                                    />
                                  ) : (
                                    ""
                                  )}
